 ...
 */
const SUPPRESS_TRACING_KEY$1 = api.createContextKey('OpenTelemetry SDK Context Key SUPPRESS_TRACING');
...
function buildSamplerFromEnv() {
    ...
    switch (sampler) {
        ...
        default:
            api.diag.error(`OTEL_TRACES_SAMPLER value "${sampler}" invalid, defaulting to "${"parentbased_always_on" /* TracesSamplerValues.ParentBasedAlwaysOn */}".`);
            return new ParentBasedSampler({
                root: new AlwaysOnSampler(),
            });
    }
