...
`;
    ...
    console.log(`${colors.green}✓${colors.reset} Created test agent: ${agentName}`);
    return agentPath;
}
...
async function runParallelTest() {
    ...
    console.log(`${colors.bright}${colors.blue}  Testing Parallel Task Execution${colors.reset}`);
    console.log(`${colors.bright}${colors.blue}═══════════════════════════════════════════${colors.reset}\n`);
    ...
    console.log(`${colors.yellow}Please invoke the following 3 tasks simultaneously:${colors.reset}\n`);
    ...
    console.log(`${colors.green}Test start time recorded: ${testStartTime}${colors.reset}`);
    console.log(`\n${colors.cyan}After tasks complete, run:${colors.reset}`);
    console.log(`${colors.bright}node tests/analyze-parallel-results.js${colors.reset}`);
}
