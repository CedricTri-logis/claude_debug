...
export const testConfig = {
    ...
    database: {
        ...
        anonKey: process.env.SUPABASE_TEST_ANON_KEY || process.env.SUPABASE_ANON_KEY,
        serviceKey: process.env.SUPABASE_TEST_SERVICE_ROLE_KEY || process.env.SUPABASE_SERVICE_ROLE_KEY,
...
export function createTestClients() {
    const adminClient = createClient(
        testConfig.database.url,
        testConfig.database.serviceKey,
        {
            auth: {
...
export async function setupTestDatabase() {
    ...
    try {
        ...
        await adminClient.rpc('exec_sql', {
            ...
            console.log('Note: exec_sql function not available, using default schema');
        });
